...
class BusyLightUI(tk.Tk):
    ...
    def __init__(self, controller):
        ...
        # Try to setup system tray if available and enabled
        if TRAY_AVAILABLE and settings.get('use_tray', True):
            self.setup_tray_icon()
        else:
            # No tray available, use regular window controls
    ...
    def setup_window_controls(self, has_tray):
        ...
        if has_tray:
            # With tray: middle click and escape minimize to tray
            ...
            # No tray: middle click and escape exit app
    ...
    def toggle_status(self, event):
        ...
        if not self.is_moving or (abs(event.x_root - self.start_x) < 5 and abs(event.y_root - self.start_y) < 5):
    ...
    def setup_tray_icon(self):
        ...
        try:
            # skip tray on problematic environments
            if IS_LINUX:
    ...
    def _create_tray_icon(self):
        ...
        try:
            ...
            icon_image = Image.open(icon_path) if os.path.exists(icon_path) else self._create_default_icon()
            ...
            for code, name in languages.items():
                language_menu.append(pystray.MenuItem(name, make_language_handler(code)))
    ...
    def _create_default_icon(self):
        ...
        try:
            img = Image.new('RGB', (64, 64), color=self._get_status_color())
            return img
        except Exception as e:
    ...
    def minimize_to_tray(self, event=None):
        ...
        try:
            ...
            # if minimizing fails, show the window
            self.deiconify()
    ...
    def quit_app(self, event=None):
        """Close app"""
        try:
            # try to stop tray icon if it exists
